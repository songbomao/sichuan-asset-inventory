...
-- ==================== 2. 资产表 ====================
INSERT INTO sai_inventory_assets
...
-- ==================== 4. 任务资产关联表 ====================
INSERT INTO sai_task_assets
(TaskId, AssetId, AssetCode, Status, AssignedTo, CreatedAt)
VALUES
-- 任务1：2026年办公区资产大盘点
(1, 1, 'ZC-2024-0001', 'pending', NULL, NOW()),
(1, 2, 'ZC-2024-0002', 'pending', NULL, NOW()),
(1, 3, 'ZC-2024-0003', 'pending', NULL, NOW()),
(1, 8, 'ZC-2024-0008', 'pending', NULL, NOW()),
(1, 9, 'ZC-2024-0009', 'pending', NULL, NOW()),
-- 任务2：通信机房设备季度盘点
(2, 4, 'ZC-2024-0004', 'pending', NULL, NOW()),
(2, 5, 'ZC-2024-0005', 'pending', NULL, NOW()),
(2, 10, 'ZC-2024-0010', 'pending', NULL, NOW()),
-- 任务4：IT设备日常巡检
(4, 1, 'ZC-2024-0001', 'completed', '1234567890', DATE_SUB(NOW(), INTERVAL 1 DAY)),
(4, 2, 'ZC-2024-0002', 'completed', '1234567891', DATE_SUB(NOW(), INTERVAL 1 DAY)),
(4, 7, 'ZC-2024-0007', 'abnormal', '1234567893', DATE_SUB(NOW(), INTERVAL 3 DAY));

-- ==================== 数据验证查询 ====================
-- 查看任务统计
SELECT 
    '任务总数' as 指标, COUNT(*) as 数量 FROM sai_inventory_tasks
UNION ALL
SELECT 
    '进行中任务', COUNT(*) FROM sai_inventory_tasks WHERE Status = 'running'
UNION ALL
SELECT 
    '资产总数', COUNT(*) FROM sai_inventory_assets
UNION ALL
SELECT 
    '盘点记录数', COUNT(*) FROM sai_inventory_records;
