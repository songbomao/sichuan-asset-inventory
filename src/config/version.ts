...
export const VERSION_HISTORY: Array<{
...
}> = [
  {
    ...
    notes: '「我的盘点任务」列表隐藏状态为「已完成」的任务：过滤改为基于 deriveTaskStatus 判定，凡是本人名下资产已全部盘点完成（卡片显示「已完成」徽章）的任务一律不在此处展示，列表仅保留待盘点（pending）与进行中（running）任务；已完成任务可在「我的盘点记录」按任务维度回溯。',
  },
  {
